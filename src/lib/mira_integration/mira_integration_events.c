...
#if MIRAMESH_RTC_ID == 0
void RTC0_IRQHandler(void)
#elif MIRAMESH_RTC_ID == 1
void RTC1_IRQHandler(void)
#elif MIRAMESH_RTC_ID == 2
...
#if MIRAMESH_SWI_ID == 0
void SWI0_EGU0_IRQHandler(void)
#elif MIRAMESH_SWI_ID == 2
void SWI2_EGU2_IRQHandler(void)
#elif MIRAMESH_SWI_ID == 3
void SWI3_EGU3_IRQHandler(void)
#elif MIRAMESH_SWI_ID == 4
void SWI4_EGU4_IRQHandler(void)
#elif MIRAMESH_SWI_ID == 5

 ...
 */
static void mira_integration_lock(
    void)
{
 ...
 */
static void mira_integration_unlock(
    void)
{
 ...
 */
static void mira_integration_wakeup_from_irq(
    void)
{
...
static void mira_integration_wakeup_from_app(
    void)
{
 ...
 */
static void mira_integration_task(
    void *pv_param)
{
    do {

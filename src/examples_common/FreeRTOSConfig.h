...
#define configKERNEL_INTERRUPT_PRIORITY (_PRIO_APP_LOWEST << (8 - __NVIC_PRIO_BITS))
#define configMAX_SYSCALL_INTERRUPT_PRIORITY (_PRIO_APP_HIGH << (8 - __NVIC_PRIO_BITS))
#define configMAX_API_CALL_INTERRUPT_PRIORITY (_PRIO_APP_HIGH << (8 - __NVIC_PRIO_BITS))
